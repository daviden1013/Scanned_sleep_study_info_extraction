...
max_length = 32
def BERT_small(trainset, test, subset_n, model_dir, pred_file):
  ...
  def model_structure():
    ...
    bert = TFBertModel.from_pretrained("bert-base-uncased", config=BertConfig(dropout=0.2, attention_dropout=0.2))
    """ seq branch """
  ...
  print('***BERT finished without errors***')
