...
def Ridge(train, test, lamb, pred_file):
  """ remove punctuation """
  ...
  print('Start fitting...')
  ridge = LogisticRegression(random_state=123, penalty='l2', C=1/lamb, max_iter=1000)
  ridge.fit(train_feature, train['label'])
  print('Finished fitting...')
  
  """ save pred """
  test_feature = make_features(vectorizer, test)
  pred = ridge.predict_proba(test_feature)
  ...
  print('***Ridge Regression finished without error***')
